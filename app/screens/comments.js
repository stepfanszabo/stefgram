...
class Comments extends React.Component {
    ...
    postComment = () => {
        ...
        if(comment != '') {
            ...
            alert('Pleaase enter a comment before posting!')
        }
    }
    ...
    render() {
        return(
            <View style={{flex: 1, backgroundColor: '#eee'}}>
                <View style={{height: 70, paddingTop: 30, backgroundColor: 'white', borderColor: 'lightgrey',borderBottomWidth: 0.5, justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row'}}>
                    <TouchableOpacity
                        style={{width: 100}}
                ...
                { this.state.loggedin == true ? (
                    ...
                    <UserAuth message={'Please login to write a comment'} moveScreen={true} navigation={this.props.navigation} />
                )}
            </View>
        )
    }
